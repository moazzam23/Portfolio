...
const NotFound = () => {
  ...
  <MdError style={{height:"4rem", width:"4rem"}}/>
    ...
    <Link to="/" style={{padding: "15px 30px"}}>
      <button  style={{ backgroundColor:"#c2102ba1",padding: "22px 80px",color:"white",border:"none",borderRadius:"10px", fontSize: '22px',fontWeight:"800", cursor: 'pointer' }}>
        Go Back
      </button>
    </Link>
  </div>
