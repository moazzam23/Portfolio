...
const Exprience = () => {
  ...
  <div className='col-12'  style={{marginTop:"-25px", backgroundColor:"#87bbd7" , borderTop:"2px solid #0b4251"}} >
    <FontAwesomeIcon onClick={handleback} icon={faCircleArrowLeft} shake className='pt-3 backbtn' />
    <h1 className='col-12 heading text-center'>  Experience</h1>
    ...
    <div className='col-6 expmain'>
      <div className='col-12 bg-danger-200 p-4' >
        <div>
          ...
          <label className='pt-2 explabel ' >Sep-2023 To Date </label>
        </div>
...
{/* <a className='explink' href=''> Check The LOE?</a> */}
          <hr style={{height:"3px",borderWidth:"0",color:"#021c24",backgroundColor:"#87bbd7"}}/>
          </div>
        <div>
          <div className='d-flex flex-row justify-content-between'>
          <h3 className=' expheading'>Premium Ebizols Digital, Bahria Town Lahore  </h3>
          <label className='pt-2 explabel ' >Aug-2022 To Oct-2022 </label>
        </div>
        <div  className='d-flex flex-row '>
          <h4 className='expheading'>Position:</h4>
...
<a rel="noreferrer" target="_blank" className='explink' href='https://drive.google.com/file/d/1jdJ38YFuTbM_7BoN_7Q9eTl04P5NcCHY/view?usp=drive_link'> Check The LOE?</a>
        ...
        <div>
          ...
          <label className='pt-2 explabel ' >Feb-2022 To March-2022 </label>
        </div>
        <div  className='d-flex flex-row '>
          <h4 className='expheading'>Position:</h4>
...
<a rel="noreferrer" target="_blank" className='explink' href='https://drive.google.com/file/d/1ZYMtwc21lhzcuD-4wDaEm7qQW5K65vsK/view?usp=drive_link'> Check The LOE?</a>
        ...
        <div>
          ...
          <label className='pt-2 explabel ' >Nov-2021 To Dec-2022 </label>
        </div>
        <div  className='d-flex flex-row '>
          <h4 className='expheading'>Position:</h4>
