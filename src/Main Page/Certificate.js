        ...
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Use reusable components to render views where data
                changes over time. Organize React projects to create more
                scalable and maintainable websites and apps <br /> <b> 2.</b>{" "}
        ...
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Create a simple form with a responsive layout using
                HTML5 and CSS Create a responsive layout using CSS.Create a UI
                using Bootstrap <br /> <b> 2.</b> Implement debugging tools. CSS
                Animation, selectors and Effect Implementation
              </p>
              <label style={{ fontSize: "1.1rem", fontWeight: "600" }}>
                Duration:{" "}
              </label>
              ...
              >
                HTML and CSS, React (Web Framework), Debugging, User Interface
              </label>
            </div>
          </div>
        </div>
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Implement Version Control systems Navigate using the
                command line. help to colaaborate when working in a large team.
                Use a GitHub repository. <br /> <b> 2.</b> Create a GitHub
                repository Manage code revisions{" "}
              </p>
              <label style={{ fontSize: "1.1rem", fontWeight: "600" }}>
                Duration:{" "}
              </label>
        ...
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Creating simple JavaScript codes. Indepth knowledge
                of object oriented language(oop). Real world coding. Writing
                unit tests using Jest <br /> <b> 2.</b>
                Creating and manipulating objects and arrays..The benefits of
              ...
              >
                JavaScript, Front-End Web Development, Object-Oriented
                Programming (OOP){" "}
              </label>
            </div>
          </div>
        ...
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Distinguish between front-end, back-end, and
                full-stack developers. benefits of writing clean code. Create
                responsive web-designs <br /> <b> 2.</b> Create and style a
                webpage with HTML and CSS.The benefits of working with UI
                frameworks.{" "}
              </p>
              <label style={{ fontSize: "1.1rem", fontWeight: "600" }}>
                Duration:{" "}
              ...
              >
                Web Development, HTML and CSS,Responsive Web Design and User
                Interface{" "}
              </label>
            </div>
          </div>
        ...
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Recognize and use common HTML5 tags. write the tag
                that matches with the functionality of the specific piece of
                code
                <br /> <b> 2.</b> Be aware of what an editor is and how to use
                one. Compose HTML5 code that can create images and links.{" "}
              </p>
              <label style={{ fontSize: "1.1rem", fontWeight: "600" }}>
                Duration:{" "}
              </label>
              ...
              >
                Web Design,Web Accessibility,HTML5 and clean code
              </label>
            </div>
          </div>
        </div>
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Identify common job responsibilities of entry-level
                UX designers and other teams .<br /> <b> 2.</b> Understand
                foundational concepts in UX design, such as user-centered
                design, the design process, and equity-focused design.{" "}
              </p>
              <label style={{ fontSize: "1.1rem", fontWeight: "600" }}>
                Duration:{" "}
              </label>
              ...
              >
                Prototype,Wireframe,User Experience Design (UXD) and UX Research{" "}
              </label>
            </div>
          </div>
        </div>
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Identify common job responsibilities of how to write
                the professional email and how convey a meaningful message to .
                <br /> <b> 2.</b> Know how to show the correct set of words and
                convey the message that is short and fullfil the purpose of
                email
              </p>
              <label style={{ fontSize: "1.1rem", fontWeight: "600" }}>
                Duration:{" "}
        ...
        <div className="cardmain2 col-12">
          <div className="card3">
            ...
            <div className="cardbody3 ">
              ...
              <p>
                <b> 1.</b> Identify common job responsibilities of entry-level
                designers and other teams you might work with.
                <br /> <b> 2.</b> Understand foundational concepts in design,
                such as Adobe Photoshop, the design process, Adobe XD,
                Prototyping, and equity-focused design.{" "}
              </p>
              <label style={{ fontSize: "1.1rem", fontWeight: "600" }}>
                Duration:{" "}
              </label>
         ...
         <a style={{paddingLeft:"10px",color:"red"}} href='https://coursera.org/verify/AYBA97HFQG3W'> Click to verify the certificate?</a> */}
              ...
              >
                Abode Photoshop, Adobe Illustrator,Canva and Adobe XD
              </label>
            </div>
          </div>
        </div>
